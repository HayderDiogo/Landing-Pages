...
const questions = [
  {
    ...
    options: [
      { value: "perder_barriga", label: "Perder barriga e gordura abdominal", icon: Scale },
      { value: "secar_corpo", label: "Secar o corpo todo", icon: Target },
      { value: "perder_peso_rapido", label: "Perder peso rapidamente", icon: Scale },
      { value: "definir_musculos", label: "Definir músculos", icon: Target },
    ],
  },
  {
    id: 2,
    title: "Quanto peso você quer perder?",
    subtitle: "Defina sua meta de perda de peso",
    options: [
      { value: "5_10kg", label: "5-10kg (incluindo barriga)", icon: Scale },
      { value: "10_20kg", label: "10-20kg (foco na barriga)", icon: Scale },
      { value: "20_30kg", label: "20-30kg (transformação completa)", icon: Scale },
  ...
  {
    id: 4,
    title: "Qual sua maior dificuldade para emagrecer?",
    subtitle: "Identifique seu principal obstáculo",
    options: [
      { value: "gordura_localizada", label: "Gordura localizada (especialmente barriga)", icon: Target },
      { value: "compulsao_doces", label: "Compulsão por doces e carboidratos", icon: Target },
      { value: "metabolismo_lento", label: "Metabolismo lento", icon: Target },
      { value: "falta_tempo", label: "Falta de tempo para exercícios", icon: Target },
    ],
  },
  {
    id: 5,
    title: "O que mais te incomoda no seu corpo?",
    subtitle: "Vamos focar no que mais te preocupa",
    options: [
      { value: "barriga_estufada", label: "Barriga sempre estufada", icon: Target },
      { value: "gordura_lateral", label: "Gordura nas laterais (pneuzinhos)", icon: Target },
      { value: "celulite", label: "Celulite e flacidez", icon: Target },
      { value: "falta_definicao", label: "Falta de definição muscular", icon: Target },
    ],
  },
  {
    id: 6,
    ...
    options: [
      { value: "15_dias", label: "15 dias (desinchar barriga rapidamente)", icon: Clock },
      { value: "1_mes", label: "1 mês (resultados visíveis no corpo)", icon: Clock },
      { value: "3_meses", label: "3 meses (transformação significativa)", icon: Clock },
      { value: "6_meses", label: "6 meses (corpo dos sonhos)", icon: Clock },
    ],
  },
  {
    id: 7,
